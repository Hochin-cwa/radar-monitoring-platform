...
docker run -d --name nginx  --add-host=host.docker.internal:host-gateway -p 3001:80 -v /data/monitor/radar-monitoring-platform/frontend:/usr/share/nginx/html:z --restart=always nginx
